    ...
    public void setModel(Model model) {
        ...
        if (textureFaces != null) {
            ...
            if (hasVanillaTexturedFaces) {
                final short[] texIndices1 = model.getTexIndices1();
                final short[] texIndices2 = model.getTexIndices2();
                final short[] texIndices3 = model.getTexIndices3();
        ...
        this.xVerticesHash = fastIntHash(model.getVerticesX(), model.getVertexCount());
        this.yVerticesHash = fastIntHash(model.getVerticesY(), model.getVertexCount());
        this.zVerticesHash = fastIntHash(model.getVerticesZ(), model.getVertexCount());
